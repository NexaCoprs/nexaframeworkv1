...
<body class="innovation-bg min-h-screen text-white">
            ...
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center space-x-8">
                    ...
                    <div class="hidden md:flex space-x-6">
                        ...
                        <a href="/contact" class="text-white hover:text-white transition-colors border-b border-white/30">Contact</a>
                    </div>
                </div>
    ...
    <!-- Header -->
    <header class="text-center py-32 pt-40" style="background: #7D4FFE;">
        <h1 class="text-6xl font-bold glow-text mb-6">Contact Us</h1>
        <p class="text-xl text-white/80 max-w-2xl mx-auto">Get in touch with the NexaFramework team and let's build something amazing together</p>
    </header>
            ...
            <div class="innovation-card rounded-2xl p-8">
                ...
                <div class="space-y-6">
                    <div class="flex items-start space-x-4">
                        <div class="w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0" style="background: #7D4FFE;">
                            <i class="fas fa-envelope text-white text-lg"></i>
                        </div>
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900 mb-1">Email</h3>
                            <p class="text-gray-600">contact@nexaframework.com</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Global Remote Team</p>
                        </div>
                    </div>
                ...
                <div class="mt-8 pt-8 border-t border-gray-200">
                    ...
                    <div class="flex space-x-4">
                        <a href="#" class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center hover:bg-gray-200 transition-colors duration-300">
                ...
                <form class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="name" name="name" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300" placeholder="Your name">
                        </div>
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-2">Email</label>
                            <input type="email" id="email" name="email" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300" placeholder="your@email.com">
                        </div>
                    </div>
                    
                    <div>
                        <label for="subject" class="block text-sm font-medium text-gray-700 mb-2">Subject</label>
                        <select id="subject" name="subject" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-300">
                            <option value="" class="bg-white">Select a subject</option>
                            ...
                            <option value="feedback" class="bg-white">Feedback</option>
                        </select>
                    </div>
                    
                    <div>
                        <label for="message" class="block text-sm font-medium text-gray-700 mb-2">Message</label>
                        <textarea id="message" name="message" rows="6" class="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none transition-all duration-300" placeholder="Tell us more about your project or question..."></textarea>
                    </div>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            button.innerHTML = '<span class="flex items-center justify-center space-x-2"><span>Sending...</span><i class="fas fa-spinner fa-spin"></i></span>';
            button.disabled = true;
            
            setTimeout(() => {
                button.innerHTML = '<span class="flex items-center justify-center space-x-2"><span>Message Sent!</span><i class="fas fa-check"></i></span>';
