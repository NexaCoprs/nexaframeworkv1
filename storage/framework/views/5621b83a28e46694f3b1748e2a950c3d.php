    ...
    <section id="bienvenue" class="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
        ...
        <div class="container mx-auto px-6 text-center relative z-10">
            ...
            <div class="inline-flex items-center px-8 py-4 rounded-full innovation-card mb-8 innovation-pulse">
                <div class="w-3 h-3 bg-gradient-to-r from-green-400 to-emerald-500 rounded-full mr-3"></div>
            ...
            <div class="flex flex-col sm:flex-row gap-6 justify-center mb-16">
                <a href="#presentation" class="px-12 py-5 bg-white text-gray-900 rounded-full font-bold text-lg hover:bg-gray-100 transition-all duration-300 shadow-2xl innovation-pulse">
                    🚀 Découvrir Nexa
                </a>
                <a href="/documentation" class="px-12 py-5 innovation-card text-white rounded-full font-bold text-lg hover:bg-white/20 transition-all duration-300">
            ...
            <div class="text-center">
                <div class="innovation-card p-12 rounded-3xl max-w-4xl mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row gap-6 justify-center">
                        <a href="/documentation" class="px-10 py-4 bg-white text-gray-900 rounded-full font-bold text-lg hover:bg-gray-100 transition-all duration-300 shadow-2xl">
                            📚 Documentation Détaillée
                        </a>
                        <a href="#fonctionnalites-futures" class="px-10 py-4 innovation-card text-white rounded-full font-bold text-lg hover:bg-white/20 transition-all duration-300">
        ...
        <div class="max-w-4xl mx-auto text-center">
            <div class="glass-morphism rounded-3xl p-12">
                ...
                <div class="flex flex-col sm:flex-row gap-6 justify-center items-center">
                    <a href="/documentation" class="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-10 py-5 rounded-2xl font-bold text-lg shadow-2xl transition-all duration-300">
                        📚 Documentation Complète
                    </a>
                    ...
                    <a href="/contact" class="bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white px-10 py-5 rounded-2xl font-bold text-lg shadow-2xl transition-all duration-300">
                        💬 Nous contacter
                    </a>
                </div>
            </div>
