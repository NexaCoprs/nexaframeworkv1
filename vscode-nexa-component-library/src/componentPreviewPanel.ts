...
import { ComponentManager, Component } from './componentManager';

export class ComponentPreviewPanel {
    public static currentPanel: ComponentPreviewPanel | undefined;
    public static readonly viewType = 'nexaComponentPreview';

    private readonly _panel: vscode.WebviewPanel;
    private readonly _extensionUri: vscode.Uri;
    private _disposables: vscode.Disposable[] = [];

    public static createOrShow(extensionUri: vscode.Uri, componentManager: ComponentManager, component?: Component) {
    ...
    private _updatePreview(component: Component) {
    ...
    private _getComponentPreviewHtml(webview: vscode.Webview, nonce: string): string {
    ...
    private _getLibraryOverviewHtml(webview: vscode.Webview, nonce: string): string {
        return `<!DOCTYPE html>
        <html lang="fr">
        <head>
            <meta charset="UTF-8">
