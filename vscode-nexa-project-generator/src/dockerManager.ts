...
export class DockerManager {
    public async setupDocker(): Promise<void> {
    ...
    private async createCompleteDockerSetup(projectPath: string): Promise<void> {
        // Dockerfile
    ...
    private async createSimpleDockerSetup(projectPath: string): Promise<void> {
    ...
    private async createMicroservicesDockerSetup(projectPath: string): Promise<void> {
    ...
    private async createPostgreSQLDockerSetup(projectPath: string): Promise<void> {
        const dockerfile = this.getDockerfileContent();
        await fs.promises.writeFile(path.join(projectPath, 'Dockerfile'), dockerfile);
    ...
    private async createKubernetesManifests(projectPath: string): Promise<void> {
...
`;
    ...
    private getSimpleDockerfileContent(): string {
...
`;
    ...
    private getMicroserviceDockerfileContent(): string {
...
`;
    ...
    private getCompleteDockerComposeContent(): string {
        return `version: '3.8'
...
`;
    ...
    private getSimpleDockerComposeContent(): string {
        return `version: '3.8'
...
`;
    ...
    private getMicroservicesDockerComposeContent(): string {
        return `version: '3.8'
...
`;
    ...
    private getPostgreSQLDockerComposeContent(): string {
        return `version: '3.8'
...
`;
    ...
    private getDockerignoreContent(): string {
        return `node_modules
npm-debug.log
vendor
composer.lock
...
`;
    ...
    private getNginxConfigContent(): string {
        return `server {
    listen 80;
...
`;
    ...
    private getPhpIniContent(): string {
...
`;
    ...
    private getKubernetesDeploymentContent(): string {
...
`;
    ...
    private getKubernetesServiceContent(): string {
...
`;
    ...
    private getKubernetesConfigMapContent(): string {
        return `apiVersion: v1
kind: ConfigMap
metadata:
