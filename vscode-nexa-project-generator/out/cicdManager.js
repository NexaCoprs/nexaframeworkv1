...
class CICDManager {
    ...
    async setupGitHubActions(projectPath) {
    ...
    async setupGitLabCI(projectPath) {
    ...
    async setupJenkins(projectPath) {
    ...
    async setupAzureDevOps(projectPath) {
    ...
    async setupAllProviders(projectPath) {
        await this.setupGitHubActions(projectPath);
        await this.setupGitLabCI(projectPath);
        await this.setupJenkins(projectPath);
        await this.setupAzureDevOps(projectPath);
    ...
    async createCommonConfigFiles(projectPath) {
...
`;
    ...
    getGitHubActionsSecurityContent() {
...
exports.CICDManager = CICDManager;
//# sourceMappingURL=cicdManager.js.map