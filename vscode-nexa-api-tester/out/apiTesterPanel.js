...
class ApiTesterPanel {
    static createOrShow(extensionUri, requestManager, themeManager) {
        ...
        const panel = vscode.window.createWebviewPanel(ApiTesterPanel.viewType, 'Nexa API Tester', column || vscode.ViewColumn.One, {
            enableScripts: true,
            localResourceRoots: [extensionUri]
        });
        ApiTesterPanel.currentPanel = new ApiTesterPanel(panel, extensionUri, requestManager, themeManager);
    }
    constructor(panel, extensionUri, requestManager, themeManager) {
        this._disposables = [];
        this._panel = panel;
    ...
    async _handleSendRequest(requestData) {
        try {
    ...
    async _handleSaveRequest(requestData) {
        try {
    ...
    async _handleRunTests(testData) {
        try {
...
ApiTesterPanel.viewType = 'nexaApiTester';
//# sourceMappingURL=apiTesterPanel.js.map