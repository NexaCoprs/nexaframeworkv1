...
class TestRunner {
    constructor(requestManager) {
        ...
        this.requestManager = requestManager || new requestManager_1.RequestManager();
    }
    async runTests(endpoint, config = {}) {
    ...
    async runPerformanceTests(response) {
        const tests = [];
    ...
    async runCustomTests(response, customTests) {
        const tests = [];
    ...
    generateMethodTest(endpoint, method) {
    ...
    static createCustomTest(name, validator) {
    ...
    static validateResponseTime(maxTime) {
        return {
    ...
    static validateStatusCode(expectedStatus) {
        return {
    ...
    static validateHeader(headerName, expectedValue) {
        return {
