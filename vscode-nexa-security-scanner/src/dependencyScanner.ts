...
export class DependencyScanner {
    private vulnerabilityDatabase: Map<string, DependencyVulnerability[]> = new Map();
    ...
    public async scanDependencies(workspacePath: string): Promise<DependencyScanResult> {
    ...
    public async scanComposerDependencies(workspacePath: string): Promise<DependencyInfo[]> {
        const dependencies: DependencyInfo[] = [];
    ...
    public async scanPackageJsonDependencies(workspacePath: string): Promise<DependencyInfo[]> {
        const dependencies: DependencyInfo[] = [];
    ...
    public async scanRequirementsTxtDependencies(workspacePath: string): Promise<DependencyInfo[]> {
        const dependencies: DependencyInfo[] = [];
    ...
    public async checkOutdatedDependencies(dependencies: DependencyInfo[]): Promise<void> {
    ...
    public generateSecurityIssues(scanResult: DependencyScanResult): SecurityIssue[] {
    ...
    private parseComposerDependencies(
    ...
    private parseComposerLockDependencies(packages: any[], file: string): DependencyInfo[] {
        const dependencies: DependencyInfo[] = [];
    ...
    private parsePackageJsonDependencies(
        deps: { [key: string]: string },
        file: string,
        type: 'direct' | 'transitive'
    ): DependencyInfo[] {
    ...
    private parseRequirementLine(line: string, file: string, lineNumber: number): DependencyInfo | null {
    ...
    private isVersionAffected(currentVersion: string, affectedVersion: string): boolean {
    ...
    private calculateScanResult(dependencies: DependencyInfo[], scanTime: number): DependencyScanResult {
    ...
    public addVulnerability(packageName: string, vulnerability: DependencyVulnerability): void {
    ...
    public updateVulnerabilityDatabase(vulnerabilities: Map<string, DependencyVulnerability[]>): void {
        this.vulnerabilityDatabase = vulnerabilities;
    }

    public getVulnerabilityDatabase(): Map<string, DependencyVulnerability[]> {
